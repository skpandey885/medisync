            ...
            <main className="flex self-center w-full h-screen place-content-center place-items-center">
                <div className="p-4 space-y-5 text-gray-600 border shadow-xl w-96 rounded-xl">
                    <div className="mb-6 text-center">
                        <div className="mt-2">
                            <h3 className="text-xl font-semibold text-gray-800 sm:text-2xl">Create a New Account</h3>
                        </div>
                    ...
                    >
                        ...
                        <div className="text-sm text-center">
                            ...
                            <Link to={'/login'} className="text-sm font-bold text-center hover:underline">Continue</Link>
                        </div>
                    </form>
                </div>
            </main>
