            ...
            <main className="flex self-center w-full h-screen place-content-center place-items-center">
                <div className="p-4 space-y-5 text-gray-600 border shadow-xl w-96 rounded-xl">
                    <div className="text-center">
                        <div className="mt-2">
                            <h3 className="text-xl font-semibold text-gray-800 sm:text-2xl">Welcome Back</h3>
                        </div>
                    </div>
                    <form
                        onSubmit={onSubmit}
                    ...
                    <p className="text-sm text-center">Don't have an account? <Link to={'/register'} className="font-bold hover:underline">Sign up</Link></p>
